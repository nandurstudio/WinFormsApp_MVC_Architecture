...
Partial Class FormSalesTransactionDetail
   ...
   Private Sub InitializeComponent()
      ...
      LabelTotal.Location = New Point(13, 50)
      LabelTotal.Name = "LabelTotal"
      LabelTotal.Size = New Size(193, 20)
      ...
      LabelTanggal.Location = New Point(13, 30)
      ...
      LabelNota.Text = "No. Transaction: TRX0001"
      ' 
      ' DataGridView1
      ' 
      ...
      DataGridView1.Columns.AddRange(New DataGridViewColumn() {KODE_BRG, NAMA_BRG, QTY, UNIT, HARGA, SUBTOTAL})
      ...
      Controls.Add(Panel2)
      Controls.Add(Panel1)
      Name = "FormSalesTransactionDetail"
      StartPosition = FormStartPosition.CenterParent
      Text = "Sales Transaction Detail"
