...
Public Class FormPurchaseTransactionDetail
   ...
   Private Sub FormPurchaseTransactionDetail_Load(sender As Object, e As EventArgs) Handles MyBase.Load
   ...
   Private Sub LoadTransactionDetail()
      Try
         ...
         Me.Text = AppInfo.GetWindowTitle($"Purchase Detail - {_purchaseID}")
         LabelNota.Text = $"No. Transaction: {_purchaseID}"
         ...
         ' Load detail items
         DataGridView1.DataSource = controller.LoadPurchaseDetailByTransaction(_purchaseID)
         ...
         If DataGridView1.Columns.Count > 0 Then
            ...
            DataGridView1.Columns("HARGA_BELI").HeaderText = "Purchase Price"
            DataGridView1.Columns("SUBTOTAL").HeaderText = "Subtotal"

            ' Format currency - RATA KANAN
            DataGridView1.Columns("HARGA_BELI").DefaultCellStyle.Format = "C2"
            DataGridView1.Columns("HARGA_BELI").DefaultCellStyle.FormatProvider = indonesianCulture
            ...
            DataGridView1.Columns("HARGA_BELI").AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells
   ...
   Private Sub ButtonExport_Click(sender As Object, e As EventArgs) Handles ButtonExport.Click
      ...
      Try
         ...
         saveDialog.FileName = $"Purchase_Detail_{_purchaseID}_{DateTime.Now:yyyyMMdd_HHmmss}.csv"
         ...
         If saveDialog.ShowDialog() = DialogResult.OK Then
            ...
            Using writer As New StreamWriter(saveDialog.FileName, False, Encoding.UTF8)
               ...
               writer.WriteLine($"# Purchase Transaction Detail")
               writer.WriteLine($"Transaction Number,{_purchaseID}")
               writer.WriteLine($"Supplier,{_supplierName}")
   ...
   Private Sub ButtonPrint_Click(sender As Object, e As EventArgs) Handles ButtonPrint.Click
      ...
      Try
         ...
         If result = DialogResult.Yes Then
            ...
            Dim title As String = $"Purchase Transaction Detail - {_purchaseID}"
            Dim footer As String = $"Supplier: {_supplierName} | Date: {_transactionDate:dd/MM/yyyy HH:mm} | Total: {_totalAmount.ToString("C2", indonesianCulture)} | Printed: {DateTime.Now:dd/MM/yyyy HH:mm}"
            Dim suggestedName As String = $"Purchase_Detail_{_purchaseID}_{DateTime.Now:yyyyMMdd_HHmmss}.pdf"
         ...
         ElseIf result = DialogResult.No Then
            ...
            Dim printHelper As New Helpers.PrintHelper()
            Dim title As String = $"Purchase Transaction Detail - {_purchaseID}"
            Dim footer As String = $"Supplier: {_supplierName} | Date: {_transactionDate:dd/MM/yyyy HH:mm} | Total: {_totalAmount.ToString("C2", indonesianCulture)}"
            Dim suggestedName As String = $"Purchase_Detail_{_purchaseID}_{DateTime.Now:yyyyMMdd_HHmmss}.pdf"
